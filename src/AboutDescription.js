...
function AboutDescription(props) {
    return (
        <div className="fadeIn" style={{ bottom: "-200px", display:"inline-block", backgroundColor:"white", height:"2000px", width:"100%", position:"relative", overflow:"hidden"}}>
           ...
           <div style={{ position: "absolute", top:"5%", left:"5%", margin:0, padding:0, width:"50%"}}>
            <p>Name: Faith Kim</p>
            ...
            <p>Hi! My name is Faith, and I currently work as a backend software engineer.
             ...
             in Mathematics.
              ...
              <p>
                ...
                of Smith College's Computer Science organization, Smithies in CS, to create a warm and inclusive space for
